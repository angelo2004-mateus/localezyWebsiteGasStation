...
const Contact = () => {
  return (
    <section id='contact' className='flex h-[50vh] w-full bg-[#EEEEEE] px-[40px]'>
        <form method='POST' action='https://formsubmit.co/dd4d8f3b8d935280662a6b6c0f3b2c2b' className='m-auto flex flex-col items-center justify-center px-[20px] gap-y-5 w-[1200px] h-[300px] rounded-lg bg-gray-300'>
